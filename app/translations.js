...
const translations = {
  ...
  sv: {
    ...
    'navigation-platform-change': 'TO_DO',
    'navigation-platform-change-details': 'TO_DO_{name}_{number}',
    'navigation-quit': 'Tillbaka',
    'navigation-remember-ticket': 'Kom du ihåg att köpa biljett?',
    'navigation-ticket': 'Biljett',
    'navigation-track-change': 'TO_DO',
    'navigation-track-change-details': 'TO_DO_{name}_{number}',
